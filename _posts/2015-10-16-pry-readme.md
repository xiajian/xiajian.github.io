...
> 激发了 学习 irb 的热情, 有空的话, 学习学习 irb 的实现.

* Source code browsing (including core C source with the pry-doc gem)
* 源代码浏览
* Documentation browsing - 文档浏览
* Live help system - 帮助系统
* Open methods in editors (`edit Class#method`)
* Syntax highlighting - 语法高亮
* Command shell integration (start editors, run git, and rake from within Pry) - 通用 shell 支持
* Gist integration
* Navigation around state (`cd`, `ls` and friends)
* Runtime invocation (use Pry as a developer console or debugger)
* Exotic object support (BasicObject instances, IClasses, ...) - 外来对象支持
* A Powerful and flexible command system - 强大的灵活的命令系统
* Ability to view and replay history - 强大的查看回调历史
...
Pry 为 Ruby 引入 REPL 驱动式编程, 其前进方向是成为 lisp 中 [SLIME](http://en.wikipedia.org/wiki/SLIME) 那样强大的工具.
...
Pry 可以从任何实现了` readline ` 方法中读数据, 并将数据写入任何实现了 `puts`. 
...
`pry`命令行 和 `.pryrc` 配置文件, `pry --help`获取更多信息.
